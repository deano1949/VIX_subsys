...
fstgeneric=ComdtyData.WTI.Generic123Price.CL1_Comdty;
sndgeneric=ComdtyData.WTI.Generic123Price.CL2_Comdty;
sndgeneric_ret=ComdtyData.WTI.Generic12Return.G2ret;
FutRollFreq=1/12;
...
%% Carry Trade
carrysignal=ComdtyData.WTI.Carry; %annualised carry
...
ExitThreshold=0;
WTIsubsys=TradeSim(sndgeneric,sndgeneric_ret,Signal,EntryThreshold,ExitThreshold,bidask_spread);%positive signal means long
WTIsubsys.Signal=Signal;
WTIsubsys.timestamp=ComdtyData.WTI.timestamp;
