function Subsys=Gatekeeper_RunSubsystem(dat,x,xret,bidask_spread,vol_target,vol,blend_type)
...
dir='C:\Users\gly19\Dropbox\GU\1.Investment\4. Alphas (new)\17.Extract_Rollyield\0.Research\VIX\dat\7.Gatekeeper\';
load(strcat(dir,'Gatekeeper_Setting.mat'));
eval(['tunepara=gatekeeper_setting.strategy']);

%% Carry Trade
carrysignal=dat.Carry; %annualised carry
tpcarry=tunepara.CarrySmoothOption;
CarryTrade= Carry(x,xret,carrysignal,bidask_spread,vol_target,vol,forecastscalar,tpcarry);
%% MACD
    tpewma=table2array(tunepara.EWMAC.parameter); %Optimal parameter for EWMA
