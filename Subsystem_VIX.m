function VIXsubsys=Subsystem_VIX()
...
ExitThreshold=0;
VIXsubsys=TradeSim(sndgeneric,sndgeneric_ret,Signal,EntryThreshold,ExitThreshold,bidask_spread);%positive signal means long
VIXsubsys.Signal=Signal;
VIXsubsys.timestamp=EquityData.VIX.timestamp;